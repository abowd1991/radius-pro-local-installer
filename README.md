...
```bash
curl -fsSL https://raw.githubusercontent.com/abowd1991/radius-pro-local-installer/v3.3.7/install.sh | sudo bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/abowd1991/radius-pro-local-installer/v3.3.7/install.sh | sudo RADIUS_PRO_RESET_MYSQL=1 bash
```
